...
class MyFragment4 :LazyFragment{

    lateinit var textView:TextView
    var handler:Handler=object :Handler(){
        override fun handleMessage(msg: Message) {
            textView.setText("4 加载完成")
            fragmentDelegater.trackLife("4 界面加载完成")
        }
    }
    ...
    override fun loadDataStop(){
        ...
        con?.cancel()
        fragmentDelegater.trackLife("4 停止一切加载")
        textView?.setText("4 stop")
    }
    ...
    fun setData(){
        ...
        fragmentDelegater.trackLife("4 开始加载数据")
