...
class MyFragment1 :LazyFragment{

    lateinit var textView:TextView
    var handler:Handler=object :Handler(){
        override fun handleMessage(msg: Message) {
            textView.setText("1 加载完成")
            fragmentDelegater.trackLife("界面加载完成")
        }
    }
    ...
    override fun loadDataStop(){
        ...
        con?.cancel()
        fragmentDelegater.trackLife("1 停止一切加载")
        textView?.setText("1 stop")
    }
    ...
    fun setData(){
        ...
        fragmentDelegater.trackLife("1 开始加载数据")
